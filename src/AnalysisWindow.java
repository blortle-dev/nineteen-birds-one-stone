...
public class AnalysisWindow {
    ...
    private void analyze() {
        ...
        String outputTable = "█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█\n█         | 0-5    | 5-10   | 10-15  | 15-20  | 20-25  | 25-30  | 30-35  | 35-65  | 65-95  | 95-125 | Total  █\n█ --------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------- █\n█    Song | "+a(s1)+" | "+a(s2)+" | "+a(s3)+" | "+a(s4)+" | "+a(s5)+" | "+a(s6)+" | "+a(s7)+" | "+a(s8)+" | "+a(s9)+" | "+a(s10)+" | "+t(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10)+" █\n█ --------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------- █\n█    Call | "+a(c1)+" | "+a(c2)+" | "+a(c3)+" | "+a(c4)+" | "+a(c5)+" | "+a(c6)+" | "+a(c7)+" | "+a(c8)+" | "+a(c9)+" | "+a(c10)+" | "+t(c1,c2,c3,c4,c5,c6,c7,c8,c9,c10)+" █\n█ --------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------- █\n█  Vision | "+a(v1)+" | "+a(v2)+" | "+a(v3)+" | "+a(v4)+" | "+a(v5)+" | "+a(v6)+" | "+a(v7)+" | "+a(v8)+" | "+a(v9)+" | "+a(v10)+" | "+t(v1,v2,v3,v4,v5,v6,v7,v8,v9,v10)+" █\n█ --------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|------- █\n█   Total | "+v(s1,c1,v1)+" | "+v(s2,c2,v2)+" | "+v(s3,c3,v3)+" | "+v(s4,c4,v4)+" | "+v(s5,c5,v5)+" | "+v(s6,c6,v6)+" | "+v(s7,c7,v7)+" | "+v(s8,c8,v8)+" | "+v(s9,c9,v9)+" | "+v(s10,c10,v10)+" | "+add(ti(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10),ti(c1,c2,c3,c4,c5,c6,c7,c8,c9,c10),ti(v1,v2,v3,v4,v5,v6,v7,v8,v9,v10))+" █\n█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█";
        outputTable = outputTable.replaceAll(" 0 ", " " + ANSI_GRAY + "0" + ANSI_RESET + " ");
